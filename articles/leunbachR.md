...
```
    ...
    ##    Likelihood ratio G^2 =    53.75 (df = 63, p = 0.7904)
...
![](leunbachR_files/figure-html/unnamed-chunk-7-1.png)
...
![](leunbachR_files/figure-html/unnamed-chunk-7-2.png)
...
cores”. Setting the option `verbose = TRUE` outputs a progress bar.
...
```
    ...
    ## --------------------------------------------------------------------------------------------------------
    ##     0        0     0.00    [ 0.00,  1.03]   0.51     0.0   0.0  61.0  38.0   1.0     0.0%
    ##     1        1     1.23    [ 0.38,  2.03]   0.55     0.0   5.0  63.0  32.0   0.0     0.0%
    ##     2        2     2.20    [ 1.64,  2.76]   0.39     0.0   2.0  83.0  15.0   0.0     0.0%
    ##     3        3     3.22    [ 2.84,  3.56]   0.30     0.0   0.0  90.0  10.0   0.0     0.0%
    ##     4        4     4.19    [ 3.85,  4.51]   0.17     0.0   0.0  97.0   3.0   0.0     0.0%
    ##     5        5     5.08    [ 4.79,  5.37]   0.00     0.0   0.0 100.0   0.0   0.0     0.0%
    ##     6        6     5.98    [ 5.64,  6.33]   0.00     0.0   0.0 100.0   0.0   0.0     0.0%
    ##     7        7     7.09    [ 6.65,  7.54]   0.26     0.0   2.0  93.0   5.0   0.0     0.0%
    ##     8        8     8.44    [ 7.68,  9.02]   0.50     0.0   0.0  53.0  47.0   0.0     0.0%
    ##     9        9     9.42    [ 8.74, 10.00]   0.52     0.0   1.0  52.0  47.0   0.0     0.0%
    ##    10       10    10.00    [ 9.35, 10.00]   0.21     0.0   4.5  95.5   0.0   0.0    12.0%
    ## --------------------------------------------------------------------------------------------------------
    ## Average SEE: 0.31
...
```
    ...
    ## 0       0     0.00     0.00     1.03       0 0.51          0
    ## 1       1     1.23     0.38     2.03       1 0.55          0
    ## 2       2     2.20     1.64     2.76       2 0.39          0
    ## 3       3     3.22     2.84     3.56       3 0.30          0
    ## 4       4     4.19     3.85     4.51       4 0.17          0
    ## 5       5     5.08     4.79     5.37       5 0.00          0
    ## 6       6     5.98     5.64     6.33       6 0.00          0
    ## 7       7     7.09     6.65     7.54       7 0.26          0
    ## 8       8     8.44     7.68     9.02       8 0.50          0
    ## 9       9     9.42     8.74    10.00       9 0.52          0
    ## 10     10    10.00     9.35    10.00      10 0.21         12
...
![](leunbachR_files/figure-html/unnamed-chunk-21-1.png)
...
![](leunbachR_files/figure-html/unnamed-chunk-22-1.png)
